...
import topicStyles from '../shared/components/Topic/Topic.module.css';
                ...
                <>
                    <section className={styles.courseCard}>
                        <div className={styles.courseInfo}>
                            <span className={styles.courseCategoury}>{selectedCourse.category}</span>
                            <span className={styles.courseName}>{selectedCourse.topic}</span>
                    ...
                    <div className={styles.topics}>
                        ...
                        {
                            courseSubTopics?.map(
                                (subTopic, index) => <Topic key={index} description={subTopic} />
                            )
                        }
                    </div>
                </>
