...
export function ResultCard({ imagePath, catigory, topic, author, courseId }) {
    return (
        <Link to={`/course-details/${courseId}`} href className={styles.card}>
            <div className={styles.imgContainer}>
                <img src={`${process.env.PUBLIC_URL}/${imagePath}`} alt={`${topic} topic logo`}></img>
            </div>
